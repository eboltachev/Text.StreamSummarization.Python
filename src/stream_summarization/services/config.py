...
class Settings(BaseSettings):
    ...
    OPENAI_MODEL_NAME: str = Field(default="Qwen/Qwen3-4B-AWQ", description="Model name for universal document insights")
...
def register_document_templates(session: Session = session_factory()):
